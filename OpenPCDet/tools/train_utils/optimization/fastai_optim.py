...
def split_params(bn_params, params, module: nn.Module, module_name=''):
    ...
    for name, child in module.named_children():
        new_name = '.'.join([module_name, name])
        split_params(bn_params, params, child, new_name)
...
class OptimWrapper():
    ...
    def create(cls, opt_func, lr,
        ...
        bn_params, params = [], []
        split_params(bn_params, params, model)
        opt = opt_func([{'params': params, 'lr': 0}, {'params': bn_params, 'lr': 0}])
